...
const generators_controller_1 = require("./generators.controller");
...
exports.GeneratorsModule = GeneratorsModule = __decorate([
    (0, common_1.Module)({
        controllers: [generators_controller_1.GeneratorsController],
        providers: [generators_service_1.GeneratorsService, prisma_service_1.PrismaService],
        exports: [generators_service_1.GeneratorsService],
    })
], GeneratorsModule);
