...
let AuditService = class AuditService {
    ...
    async logRepresentativeLogin(representativeId, ipAddress, userAgent) {
        await this.log({
            representativeId,
            action: 'LOGIN',
    ...
    async logRepresentativeLogout(representativeId, ipAddress, userAgent) {
        await this.log({
            representativeId,
            action: 'LOGOUT',
            entityType: 'Representative',
    ...
    async logRepresentativeCreate(representativeId, entityType, entityId, newValues, ipAddress, userAgent) {
        await this.log({
            representativeId,
            action: 'CREATE',
            entityType,
    ...
    async logRepresentativeUpdate(representativeId, entityType, entityId, oldValues, newValues, ipAddress, userAgent) {
        await this.log({
            representativeId,
            action: 'UPDATE',
            entityType,
    ...
    async logRepresentativeDelete(representativeId, entityType, entityId, oldValues, ipAddress, userAgent) {
        await this.log({
            representativeId,
            action: 'DELETE',
            entityType,
