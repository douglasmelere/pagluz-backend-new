...
__decorate([
    (0, swagger_1.ApiProperty)({
        ...
        enum: enums_1.SourceType,
        example: enums_1.SourceType.SOLAR,
    }),
    (0, class_validator_1.IsEnum)(enums_1.SourceType),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({
        ...
        enum: enums_1.GeneratorStatus,
        example: enums_1.GeneratorStatus.UNDER_ANALYSIS,
        required: false,
    }),
    (0, class_validator_1.IsEnum)(enums_1.GeneratorStatus),
